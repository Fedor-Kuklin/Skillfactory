...
from django.forms import ChoiceField, CharField, MultipleChoiceField
...
class PostForm(ModelForm):
    ...
    # author = forms.ModelMultipleChoiceField(queryset=User.objects.filter(groups=group_id.id), widget=Select)
