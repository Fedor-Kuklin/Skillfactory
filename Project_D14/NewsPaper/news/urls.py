...
from .views import PostList, UserList, PostDetail, UserDetail, SearchPost, PostCreateView, PostUpdateView, \
                     PostDeleteView, UserCreateView, UserUpdateView, CategoryList, add_subscribe, remove_subscribe, \
                     set_timezone
...
urlpatterns = [
   ...
   path('<int:pk>/subscribe_add/', add_subscribe, name='subscribe_category_add'),
   path('<int:pk>/subscribe_del/', remove_subscribe, name='subscribe_category_del'),
